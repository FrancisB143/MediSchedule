  ...
  return (
    <>
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-gray-800">Shift Swap Requests</h1>
          <p className="text-sm text-gray-500">Request to swap shifts with your colleagues</p>
        </div>
        <button className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg font-medium hover:from-blue-600 hover:to-blue-700 transition-all shadow-md">
      ...
      <div>
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Your Upcoming Shifts</h2>
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <h4 className="text-lg font-semibold text-gray-800 mb-2">Morning Shift</h4>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <div className="flex items-center gap-2 mb-4 text-blue-600">
              ...
              <h3 className="text-lg font-semibold">Sunday</h3>
            </div>
            <p className="text-sm text-gray-500 mb-3">2024-06-16</p>
            <h4 className="text-lg font-semibold text-gray-800 mb-2">Night Shift</h4>
            <div className="flex items-center gap-2 text-gray-600">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <div className="flex items-center gap-2 mb-4 text-blue-600">
              ...
              <h3 className="text-lg font-semibold">Tuesday</h3>
            </div>
            <p className="text-sm text-gray-500 mb-3">2024-06-18</p>
            <h4 className="text-lg font-semibold text-gray-800 mb-2">Afternoon Shift</h4>
            <div className="flex items-center gap-2 text-gray-600">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
